...
#barplot(pants$probability, names.arg = pants$type)
```
...
4 ~ Binomial(1/6, 20) # i get 4 times skull in 20 dieces throw
...
#dbinom(x=3, size= 20, prob=1/2)
#dbinom (x=3,size= 100, prob= 1/2)
```
